...
void CAI_BaseNPC::InitDefaultScheduleSR(void)
{
	...
	ADD_DEF_SCHEDULE( "SCHED_JUMP_FORWARD",					SCHED_JUMP_FORWARD );
}
...
//	AI_LOAD_DEF_SCHEDULE( CAI_BaseNPC,					SCHED_NONE);
	...
	AI_LOAD_DEF_SCHEDULE( CAI_BaseNPC,					SCHED_JUMP_FORWARD );
...
//	"		TASK_SET_TOLERANCE_DISTANCE		24"
	"		TASK_GET_CHASE_PATH_TO_ENEMY	2000"
	"		TASK_RUN_PATH					0"
	"		TASK_WAIT_FOR_MOVEMENT			0"
	"		TASK_FACE_ENEMY			0"
	""
...
//	"		TASK_SET_TOLERANCE_DISTANCE		48"
	...
	"		TASK_GET_PATH_TO_RANDOM_NODE	2048"
	"		TASK_RUN_PATH					0"
	"		TASK_WAIT_FOR_MOVEMENT			0"
	""
	"	Interrupts"
