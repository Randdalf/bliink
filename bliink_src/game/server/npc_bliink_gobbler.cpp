...
//=========================================================
//=========================================================
class CBliinkGobbler : public CAI_BaseNPC
{
	DECLARE_CLASS( CBliinkGobbler, CAI_BaseNPC );
...
LINK_ENTITY_TO_CLASS( npc_bliink_gobbler, CBliinkGobbler );
IMPLEMENT_CUSTOM_AI( npc_citizen, CBliinkGobbler );


//---------------------------------------------------------
// Save/Restore
//---------------------------------------------------------
BEGIN_DATADESC( CBliinkGobbler )
...
// Output :
//-----------------------------------------------------------------------------
void CBliinkGobbler::InitCustomSchedules(void) 
{
	INIT_CUSTOM_AI(CBliinkGobbler);

	ADD_CUSTOM_TASK(CBliinkGobbler,		TASK_MYCUSTOMTASK);

	ADD_CUSTOM_SCHEDULE(CBliinkGobbler,	SCHED_MYCUSTOMSCHEDULE);

	//ADD_CUSTOM_ACTIVITY(CBliinkSimpleNPC,	ACT_MYCUSTOMACTIVITY);

	ADD_CUSTOM_CONDITION(CBliinkGobbler,	COND_MYCUSTOMCONDITION);
}
...
//
//-----------------------------------------------------------------------------
void CBliinkGobbler::Precache( void )
{
...
//
//-----------------------------------------------------------------------------
int CBliinkGobbler::SelectSchedule( void )
{
...
//
//-----------------------------------------------------------------------------
void CBliinkGobbler::Spawn( void )
{
	Precache();
...
Activity	CBliinkGobbler::NPC_TranslateActivity( Activity eNewActivity )
{
...
// Output : 
//-----------------------------------------------------------------------------
Class_T	CBliinkGobbler::Classify( void )
{
	return	CLASS_NONE;
}