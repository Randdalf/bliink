...
// SDK TEMPLATE: John - Considering revising, GetGameState() crashes options menu ( Add states to SDK gamerules? )
...
ConVar asw_background_color( "asw_background_color", "16 32 46 128", FCVAR_NONE | FCVAR_DEVELOPMENTONLY, "Color of background tinting in briefing screens" );
