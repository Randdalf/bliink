...
#include "weapon_sdkbase.h"
	...
	#define CWeaponBPistol C_WeaponBPistol
...
class CWeaponBPistol : public CWeaponSDKBase
{
public:
	DECLARE_CLASS( CWeaponBPistol, CWeaponSDKBase );
...
private:
	...
	CWeaponBPistol( const CWeaponBPistol & );
};
...
LINK_ENTITY_TO_CLASS( weapon_bliink-pistol, CWeaponBPistol );
PRECACHE_WEAPON_REGISTER( weapon_bliink_pistol );



CWeaponBPistol::CWeaponBPistol()
{
}

//Tony; todo; add ACT_MP_PRONE* activities, so we have them.
acttable_t CWeaponBPistol::m_acttable[] = 
{
...
IMPLEMENT_ACTTABLE( CWeaponBPistol );
