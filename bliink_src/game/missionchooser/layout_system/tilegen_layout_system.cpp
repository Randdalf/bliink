...
ConVar tilegen_break_on_iteration( "tilegen_break_on_iteration", "-1", FCVAR_CHEAT | FCVAR_DEVELOPMENTONLY, "If set to a non-negative value, tilegen will break at the start of iteration #N if a debugger is attached." );
