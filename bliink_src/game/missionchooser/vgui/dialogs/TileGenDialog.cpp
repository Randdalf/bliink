...
ConVar tilegen_preprocess_mission( "tilegen_preprocess_mission", "0", FCVAR_CHEAT | FCVAR_DEVELOPMENTONLY, "If set to 1, tilegen will dump the pre-processed mission file to preprocess_mission.txt." );
