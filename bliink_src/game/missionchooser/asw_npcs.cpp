...
ConVar asw_encounters_distance_min( "asw_encounters_distance_min", "900", FCVAR_CHEAT | FCVAR_DEVELOPMENTONLY, "Min distance between edges of encounter circles" );
ConVar asw_encounter_radius_min( "asw_encounter_radius_min", "384.0f", FCVAR_CHEAT | FCVAR_DEVELOPMENTONLY );
ConVar asw_encounter_radius_max( "asw_encounter_radius_max", "512.0f", FCVAR_CHEAT | FCVAR_DEVELOPMENTONLY );
