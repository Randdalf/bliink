...
ConVar asw_location_grid_debug( "asw_location_grid_debug", "0", FCVAR_NONE | FCVAR_DEVELOPMENTONLY, "Outputs mission grid hexes for server and client" );
ConVar asw_unlock_all_locations( "asw_unlock_all_locations", "0", FCVAR_CHEAT | FCVAR_DEVELOPMENTONLY, "Unlocks all mission hexes" );
